/*
 * Generated by ISE 15.12.9.8497 GPL Edition - unix
 */
...
void egc_init_plug (void)
{
	...
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F298_3500;
	...
	egc_sp_bool = 0x0212;
	egc_sp_uint8 = 0x01D7;
	egc_sp_uint16 = 0x0235;
	egc_sp_uint32 = 0x01AB;
	egc_sp_uint64 = 0x0161;
	egc_sp_int8 = 0x028B;
	egc_sp_int16 = 0x02A8;
	egc_sp_int32 = 0x013B;
	egc_sp_int64 = 0x02C5;
	egc_sp_real32 = 0x026E;
	egc_sp_real64 = 0x0251;
	egc_sp_pointer = 0x01B1;
	egc_sp_ref = 0x0128;
	...
	egc_system_name = "scoop_project";
	egc_system_location = "/home/irma/scoop_project/EIFGENs/scoop_project/W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1460119774;
	...
	egc_rlist[0] = "H2O_MOLECULES.make";
	egc_rcdt[0] = 0;
	egc_rcrid[0] = 4897;
	egc_rcarg[0] = 0;
